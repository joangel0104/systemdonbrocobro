...
use Mike42\Escpos\Printer;
 ...
 $sql="SELECT a.nombre,a.grado,a.seccion,a.codigo,c.nombre,d.nombre,b.credito_generado,b.monto,b.fecha
FROM alumnos a
...
$printer->text("Fecha de Pago:".$aux8. "\n");
$printer->setTextSize(2, 2);
$printer->text("---------------------" . "\n");
$printer->setTextSize(1, 1);
...
$printer->text("....Copia ticket ultimo pago...\n");
