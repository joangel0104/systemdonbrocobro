                    ...
                    <div class="inner">
                        ...
                        <center>
                            <div class="derecha" id="buscar">
                                <br>
                                <h4 id="text_6">
                                    <img height="20" src="images/busqueda.png">Consultar Alumno
                                </h4>
                                <input  maxlength="100" 
                                    type="search" 
                                ...
                                <select name="tipo_grado" 
                                    id="tipo_grado" 
                                    onclick="filtrar_table()">
                            ...
                            <table class="order-table table" id="tabla_1" >
                                ...
                                <?PHP while( $row=mysqli_fetch_array($stmt1, MYSQLI_NUM)) {?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" id="abrir_popup" onclick="ver_id()" >  
	   ...
	   <script src="assets/js/main.js"></script>
        ...
        <div class="overlay" id="overlay">
            <div class="popup" id="popup">
                ...
                <h3>
                    <img height="40" src="images/refrescar.png">
                Actualizar Alumno
                </h3>
                <form action="">
